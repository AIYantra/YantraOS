...
# ── Create /root directory and boot script ────────────────────────────────────
# mkarchiso will fail if /root doesn't exist when applying file_permissions.
log_info "Creating /root directory in airootfs..."
install -dm750 "${AIROOTFS}/root"
log_ok "/root directory created."

# Generate the first-boot autopilot script
log_info "Generating /root/.automated_script.sh..."
cat > "${AIROOTFS}/root/.automated_script.sh" << 'BOOTSCRIPT'
#!/usr/bin/env bash
...
log_ok ".automated_script.sh generated."

# ── Create yantra_user home directory ─────────────────────────────────────────
log_info "Creating /home/yantra_user in airootfs..."
install -dm700 "${AIROOTFS}/home/yantra_user"
chown 1000:1000 "${AIROOTFS}/home/yantra_user"
log_ok "yantra_user home directory created."
